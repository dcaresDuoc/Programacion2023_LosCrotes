  ...
  return (
    <div className='section-about'>
      <div className='container-info'>
        ...
        <h3 style={{color: 'purple'}}>Acerca de</h3>
        <Image src={Logo} alt='logo de la empresa' width={140} height={100}/>
        </div>
          <div style={{ display: 'flex', justifyContent: 'center'}}>
          <Image className='note-img' src={NotePhoto} alt={NotePhoto} width={400} height={230} style={{marginRight: '10px'}}/>

          <Image className='tablet-img' src={TablePhoto} alt={TablePhoto} width={400} height={230} style={{marginLeft: '10px'}}/>
          </div>
        </div>
        ...
        <div className='container-info' style={{ textAlign: 'right', margin: '20px' }}>
          <p style={{ marginBottom: '20px' }}>Bienvenido a Findsome, una empresa de servicios de entrega a domicilio que ofrece una amplia variedad de opciones para satisfacer tus necesidades. Nos enorgullecemos de ofrecer servicios de alta calidad a nuestros clientes y nos esforzamos por garantizar que cada entrega sea rápida, segura y eficiente.
